...
# Materias (asignaturas) que imparte un profesor
class Materia(models.Model):
    ...
    # Lista de días seleccionados; almacenada como JSON (p.ej. ["Lunes","Miércoles"]) 
    ...
    def __str__(self):
        return f"{self.nrc} - {self.nombre} ({self.seccion})"
